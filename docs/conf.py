...
htmlhelp_basename = 'scanning-squiddoc'
...
latex_documents = [
    (master_doc, 'scanning-squid.tex', 'scanning-squid Documentation',
     'Logan Bishop-Van Horn', 'manual'),
]
...
man_pages = [
    (master_doc, 'scanning-squid', 'scanning-squid Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'scanning-squid', 'scanning-squid Documentation',
     author, 'scanning-squid', 'Scanning SQUID measurement and control.',
     'Miscellaneous'),
]
